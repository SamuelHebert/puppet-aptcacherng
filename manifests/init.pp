...
class aptcacherng (
  ...
  Optional[Stdlib::Absolutepath] $supportdir,
  Optional[String]               $bindaddress,
  Optional[String]               $proxy,
  Optional[Array]                $remap_lines,
  Optional[Stdlib::Absolutepath] $socketpath,
  Optional[Stdlib::Absolutepath] $unbufferlogs,
  Optional[Stdlib::Absolutepath] $verboselog,
  Optional                       $foreground,
  Optional[Stdlib::Absolutepath] $pidfile,
  Optional                       $offlinemode,
  Optional                       $forcemanaged,
  Optional                       $exabortonproblems,
  Optional                       $stupidfs,
  Optional                       $forwardbtssoap,
  Optional                       $dnscacheseconds,
  ...
  Optional                       $dontcacherequested,
  Optional                       $dontcacheresolved,
  Optional                       $dontcache,
  Optional                       $dirperms,
  Optional                       $fileperms,
  Optional                       $localdirs,
  Optional                       $precachefor,
  Optional                       $requestappendix,
  Optional                       $connectproto,
  Optional                       $keepextraversions,
  Optional                       $usewrap,
  Optional                       $freshindexmaxage,
  Optional                       $allowuserports,
  Optional                       $redirmax,
  Optional                       $vfileuserangeops,
  Optional                       $passthroughpattern,
