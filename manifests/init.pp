...
class aptcacherng (
  ...
  Optional[Stdlib::Absolutepath] $supportdir           = undef,
  Optional[String]               $bindaddress          = undef,
  Optional[String]               $proxy                = undef,
  Optional[Array]                $remap_lines          = undef,
  Optional[Stdlib::Absolutepath] $socketpath           = undef,
  Optional[Stdlib::Absolutepath] $unbufferlogs         = undef,
  Optional[Stdlib::Absolutepath] $verboselog           = undef,
  Optional                       $foreground           = undef,
  Optional[Stdlib::Absolutepath] $pidfile              = undef,
  Optional                       $offlinemode          = undef,
  Optional                       $forcemanaged         = undef,
  Optional                       $exabortonproblems    = undef,
  Optional                       $stupidfs             = undef,
  Optional                       $forwardbtssoap       = undef,
  Optional                       $dnscacheseconds      = undef,
  Optional                       $maxstandbyconthreads = undef,
  Optional                       $maxconthreads        = undef,
  Optional                       $vfilepattern         = undef,
  Optional                       $pfilepattern         = undef,
  Optional                       $wfilepattern         = undef,
  Optional                       $debug                = undef,
  Optional                       $exposeorigin         = undef,
  Optional                       $logsubmittedorigin   = undef,
  Optional                       $useragent            = undef,
  Optional                       $recompbz2            = undef,
  Optional                       $networktimeout       = undef,
  Optional                       $dontcacherequested   = undef,
  Optional                       $dontcacheresolved    = undef,
  Optional                       $dontcache            = undef,
  Optional                       $dirperms             = undef,
  Optional                       $fileperms            = undef,
  Optional                       $localdirs            = undef,
  Optional                       $precachefor          = undef,
  Optional                       $requestappendix      = undef,
  Optional                       $connectproto         = undef,
  Optional                       $keepextraversions    = undef,
  Optional                       $usewrap              = undef,
  Optional                       $freshindexmaxage     = undef,
  Optional                       $allowuserports       = undef,
  Optional                       $redirmax             = undef,
  Optional                       $vfileuserangeops     = undef,
  Optional                       $passthroughpattern   = undef,
  Optional                       $auth_username        = undef,
  Optional                       $auth_password        = undef,
  Optional                       $max_files            = undef,
